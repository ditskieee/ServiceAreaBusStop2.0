...
var lyr_Roads_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Roads<br />\
    <img src="styles/legend/Roads_2_0.png" /> Bundaran ITS<br />\
    <img src="styles/legend/Roads_2_1.png" /> Jalan Doktor Insinyur Haji Soekarno<br />\
    <img src="styles/legend/Roads_2_2.png" /> Jalan Raya ITS<br />\
    <img src="styles/legend/Roads_2_3.png" /> Jalan Raya Kertajaya Indah<br />' });
...
lyr_BusStop_3.set('fieldAliases', {'Halte': 'Halte', 'Jalan': 'Jalan', 'Foto': 'Foto', });
...
lyr_BusStop_3.set('fieldImages', {'Halte': 'TextEdit', 'Jalan': 'TextEdit', 'Foto': 'ExternalResource', });
lyr_ServiceArea_1.set('fieldLabels', {'id': 'header label - visible with data', 'cost_level': 'header label - visible with data', });
lyr_Roads_2.set('fieldLabels', {'full_id': 'hidden field', 'osm_id': 'hidden field', 'osm_type': 'hidden field', 'highway': 'hidden field', 'name': 'header label - visible with data', });
lyr_BusStop_3.set('fieldLabels', {'Halte': 'header label - visible with data', 'Jalan': 'header label - visible with data', 'Foto': 'header label - visible with data', });
